...
fun queryTexts(context: Context) : List<List<String>> {
    ...
    val my2DIntList : List<List<String>> = listOf(texts,prices,times,moneys)
...
fun insertText(context: Context, text: String, price: String, time: String, money: Int){
...
class TimeRecord(val id : Long, val text : String, val price : Long, val time :Long, val money :Long)
