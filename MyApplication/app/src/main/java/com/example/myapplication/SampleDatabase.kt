...
fun selectInDay(context: Context, year: Int, month: Int) : List<List<String>>{
    ...
    val from =(0 + month  * 100 + year * 10000).toString()
    val to = (0 + (month +1) * 100 + year * 10000).toString()
    ...
    val returnDatas : List<List<String>> = listOf(texts,prices,times,moneys,idates)
